...
\name{Joana Matos Fonseca da Trindade}
 
\begin{resume}
 
\section{CONTACT \\ INFORMATION}  Joana M. F. da Trindade \hfill jmf@google.com \\
               76 Ninth Ave, Google, 4th floor  \hfill jmftrindade@gmail.com \\
               New York, NY, 10011 \hfill \url{http://joanatrindade.wikidot.com}
               


\section{RESEARCH \\ INTERESTS}       \textbf{Distributed storage systems, distributed data processing systems, large-scale computer architecture, systems performance analysis, and systems security.} 
 
\section{EDUCATION} \textbf{University of Illinois at Urbana-Champaign} \hfill 2009--2011 \\
...
Highly proficient in \textbf{multithreading}, \textbf{C++}, and \textbf{Java}.  Proficient in \textbf{Python}, \textbf{MapReduce}, \textbf{JavaScript}, and \textbf{R}.
 
\section{AWARDS AND HONORS} 

\textbf{10 Google Peer Bonuses, 5 Google Kudos Awards, 1 Google Spot Bonus}, for technical and professional service contributions.  Spot bonus awarded for internal launch of fleet-wide read / write RPC real-time latency analysis of Colossus clients and related storage servers, 2012--2015.
...
\textbf{Information Trust Institute Student Travel Scholarship} to attend IEEE Symposium on Security and Privacy 2010.

\textbf{CRA-W Travel Scholarship} to attend the 2010 CRA-W Graduate Cohort Workshop.

\textbf{Nominated for Microsoft Research Graduate Women's Scholarship}, UIUC CS department, 2009.

\textbf{Overachievement bonus at the end of internship}, SAP Research - Security \& Trust, France, 2008.

\textbf{11-month Scholarship for Undergraduate Research}, Fraunhofer IESE, Germany, 2006--2007.
...
\textbf{Student Grant Scholarship} to attend the 2005 Brazilian Symposium on Formal Methods (SBMF 2005).

\section{EXPERIENCE} \textbf{Google Inc}, New York, NY \hfill 2012--Present \\
                {\sl Software Engineer, Apps and Storage Infrastructure}
                \begin{itemize}  \itemsep -2pt
                \item  2015--Present: Project not yet publicly announced.  In charge of infrastructure and 
                monitoring tasks on both backend and frontend components.
		...
		\item Techs: C++, MapReduce, Java, Python, JavaScript, R.
               ...
               \item Supported by a Siebel Scholar Fellowship, awarded to top 5 students in the top 5 CS 
                ...
                {\sl Research Assistant}, Parallel and Distributed Processing group, August 2010--June 2011
                \begin{itemize}  \itemsep -2pt
...
M. Rafaelli, \textbf{J. M. F. Trindade,} G. Jacques-Silva, T. S. Weber and I. Jansch-Pôrto, \href{http://joanatrindade.wikidot.com/local--files/curriculum/erad2006.pdf}{``Fault Scenario Configuration for Experimental Validation of Distributed Applications in FIONA"} (extended abstract, in Portuguese) \textit{VI Regional School of High Performance (ERAD 2006), pp. 135-138, Ijuí, Brazil, January 10-14, 2006.}
