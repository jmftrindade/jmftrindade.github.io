...
\section{RESEARCH \\ INTERESTS}       \textbf{Distributed storage systems, distributed data processing systems, systems performance analysis,
                                              and large-scale computer architectures.} 
...
\section{EDUCATION} \textbf{Massachusetts Institute of Technology} \hfill Fall 2016-- Summer 2020 (expected) \\
                ...
                \item Graduate Coursework: Database Systems, Intro to Research in EECS, Distributed Systems (Spring 2017)
                \end{itemize}
