...
\section{CONTACT \\ INFORMATION}  Joana M. F. da Trindade \hfill jmftrindade@gmail.com \\
               Cambridge, MA, 02139 \hfill \url{http://jmftrindade.github.io}
               


\section{RESEARCH \\ INTERESTS}       \textbf{Distributed storage systems, distributed data processing systems, large-scale computer architectures, systems performance analysis, and systems security.} 
 
\section{EDUCATION} \textbf{Massachusetts Institute of Technology} \hfill Fall 2016-- Summer 2020 (expected) \\
                {\sl PhD in Computer Science} \\
                Working with Prof. Sam Madden and Dr. Raul Castro Fernandez at MIT's Database Group.
                \begin{itemize}  \itemsep -2pt
                \item Graduate Coursework: 6.830 Database Systems (Fall 2016)
                \end{itemize}
...
\textbf{ODGE Diversity Tuition Award}, MIT, 2016.
